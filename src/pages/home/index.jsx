          ...
          <div id="home-content">
            <div id="about-scrc" className="about-container">
              <div>
                <h1>South Central Regional Conference</h1>
                <p>
                  The South Central Regional Conference, also known as SCRC, is
                  one of the five annual regional conferences held across the
                  United States. Within the south-central region, our conference
                  encompasses SASE chapters from Texas, Oklahoma, and Louisiana.
                </p>
                <br />
                <p>
            ...
            <div id="trip-details" className="about-container">
              <h1>Trip Details</h1>
              <p>
                March 2nd, 2024
                <br />
            ...
            <div id="about-sase" className="about-container">
              ...
              <p>
                ...
                SASE, is a non-profit organization with over 100 chapters across
                the United States. As a home and support system to thousands of
                collegiate and national volunteers, we at SASE embrace the
                mission to prepare Asian heritage scientists and engineers for
                success in the global professional world.
              </p>
              <h2>SASE TAMU</h2>
              <p>
                In our chapter at Texas A&M University, we enhance our
                experiences and growth through the combination of core pillars
                found in SASE and the Aggie spirit. We are dedicated to
                promoting community health while also nuturing and enhancing the
                leadership and professional skills of our members. We provide
                professionally and personally engaging events ranging from GBMs
                and workshops to mixers and trivia nights for 100+ registered
                members.
              </p>
            </div>
          </div>
